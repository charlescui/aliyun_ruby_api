...
# 
ALIYUNACCESSKEYID=lexivhd7dO1Gc2dF ALIYUNACCESSKEYSECRET=terzhCes8Fv5Hswx1pLev4uzwEF9s2 bundle exec rails c production
# 重启CMS弹性伸缩组的所有服务器
# 重启CMS非弹性伸缩组的固定服务器
@deploy = Aliyun::Deploy::Worker.new(Aliyun::EcsApi.new, Aliyun::EssApi.new("bY8sLhdgqZB3cIu7Ufdj4dTZ"))
@deploy.make
=end
